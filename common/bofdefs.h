...
#endif
#ifdef BOF
WINBASEAPI WINBOOL WINAPI KERNEL32$SetCurrentDirectoryA (LPCSTR lpPathName);
#endif
...
WINBASEAPI DWORD WINAPI NETAPI32$NetGroupEnum(LPCWSTR servername,DWORD level,LPBYTE *bufptr,DWORD prefmaxlen,LPDWORD entriesread,LPDWORD totalentries,PDWORD_PTR resumehandle);
...
DECLSPEC_IMPORT DWORD WINAPI NETAPI32$DsEnumerateDomainTrustsA(LPCSTR ServerName, DWORD Flags, PVOID* Domains, PDWORD DomainCount);
...
WINBASEAPI NTSTATUS NTAPI NTDLL$RtlGetVersion(PRTL_OSVERSIONINFOW lpVersionInformation);
...
#define KERNEL32$GetLogicalDrives GetLogicalDrives
...
#define NETAPI32$DsEnumerateDomainTrustsA DsEnumerateDomainTrustsA
...
#define NETAPI32$NetGroupEnum NetGroupEnum
...
#define NTDLL$RtlGetVersion RtlGetVersion
